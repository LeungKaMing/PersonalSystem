...
# 插入默认信息 - 用户信息
INSERT INTO `user_info` set name='ljm', email='510314588@qq.com', password='19920926ljm';
INSERT INTO `user_info` set name='admin', email='admin@qq.com', password='admin123456';